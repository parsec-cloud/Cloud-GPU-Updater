...
$onlineversion = (Invoke-WebRequest -uri "https://raw.githubusercontent.com/jamesstringerparsec/Cloud-GPU-Updater/master/GPU%20Updater%20Tool.ps1").Content.Substring(10,3)
